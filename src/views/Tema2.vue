...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-stretch.justify-content-center.mb-4.mb-lg-5
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-primario.p-4.px-5.h-100
          ...
          p.mb-0 Se enfoca en buscar un diferenciador que no es exclusivo, pero se puede utilizar mientras no sea usado por la competencia.
    ...
    #t_2_2.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 2.2 Bases para un plan de medios digitales
    ...
    TabsB.color-secundario.mb-5
      .py-4.py-md-5.px-3(titulo="Publicidad" :icono="require('@/assets/curso/tema2/13.png')")
        .row.justify-content-center.align-items-center
          .col-lg-7.col-xl-6
            h5 Publicidad
    ...
    .titulo-con-imagen.mb-5(data-aos="fade-right").z-2
      .titulo-con-imagen__fondo
        img.titulo-con-imagen__imagen(src="@/assets/curso/common/icon-title.png")
        h4.titulo-con-imagen__texto Plan de medios digitales

    .bg-azul-claro.p-4.mb-4.mb-lg-5.rounded-4
      .row.justify-content-center.align-items-center
        .col-lg-9.col-xl-9
          .p-3.p-xl-0
        ...
        SlyderF(columnas="col-lg-6")
          .tarjeta.tarjeta--blanca.px-4.pt-5.factores-slider__tarjeta
            ...
            .factores-slider__title-wrapper  
              h4.factores-slider__title.mb-4 Investigar
            p.mb-4.mb-5.text-center Análisis del entorno en que se desenvuelve la marca, así como su público objetivo y los medios que este consume, además de todos los elementos que cada marca establece.
          .tarjeta.tarjeta--blanca.px-4.pt-5.factores-slider__tarjeta
            .row.justify-content-center.mb-3
              .col-6
                img(src='@/assets/curso/tema2/22.png' alt='')
            .factores-slider__title-wrapper  
              h4.factores-slider__title.mb-4 Plantear objetivos
            p.mb-4.mb-5.text-center Se caracteriza por definir qué se quiere obtener con el plan de medios. De acuerdo con los intereses de la marca, se determinan los objetivos.
          .tarjeta.tarjeta--blanca.px-4.pt-5.factores-slider__tarjeta
            .row.justify-content-center.mb-3
              .col-6
          ...
          .tarjeta.tarjeta--blanca.px-4.pt-5.factores-slider__tarjeta
            ...
            .factores-slider__title-wrapper  
              h4.factores-slider__title.mb-4 Pensar la estrategia
            p.mb-4.mb-5.text-center De acuerdo con los recursos y siguiendo la consecución de los objetivos propuestos, se elige la estrategia que mejor se adapte al plan de medios.
          .tarjeta.tarjeta--blanca.px-4.pt-5.factores-slider__tarjeta
            .row.justify-content-center.mb-3
              .col-6
                img(src='@/assets/curso/tema2/25.png' alt='')
            .factores-slider__title-wrapper  
              h4.factores-slider__title.mb-4 Actuar
            p.mb-4.mb-5.text-center Momento de llevar a cabo las actividades definidas según la estrategia elegida, con las herramientas que se consideren adecuadas.
          .tarjeta.tarjeta--blanca.px-4.pt-5.factores-slider__tarjeta
            .row.justify-content-center.mb-3
              .col-6
